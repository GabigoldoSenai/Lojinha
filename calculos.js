    ...
    switch (menu) {
        ...
        case 1:
            ...
            */
            ...
            let la = { quantidade: 0, peso: 0, preco_total: 0, tipo: 0 }, espuma, feltro, olhos, preco = { lucro_bruto: 0, investimento: 0, lucro_liquido: 0, custo: 0, tempo: 0, total: 0 }
        ...
        case 2:
            ...
            switch (menu_2) {
                case 1:
                    document.write("Preço base:<br>mínimo:R$24.00   Meio-termo= R$32.00    Máximo:R$39.00<th> <br>Preço base + 35% = R$10.98<br> Lucro líquido = Lucro líquido: R$11.81 || Para investir/guardar: R$5.06")
                    break;
                default:
                    alert("Opção não")
